  ...
  return (
    <div className="flex flex-col items-center justify-items-center min-h-screen font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-y-4 p-4 row-start-2 items-center justify-center  w-full h-full">
        ...
        <div className="w-11/12 md:w-3/4 self-center h-64 md:h-[20vh] rounded-lg p-8 flex flex-col items-center justify-center">
          <p className="h-1/4 w-full text-center font-bold text-[40px]">
            Trusted by:
          </p>
